...
function StoryModule() {
  ...
  this.intentResponse = function(req, res) {
    ...
    if (randomStoryId === undefined) {
      prompt = 'You have completed all stories of this week. Please wait for another week for new set of mystery stories. Till then, would you like to solve some riddles?';
